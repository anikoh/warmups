...
var firstArray = ["Skynet","Digital Music Distribution",
...
var secondArray = ["Facebook Platform","Erlang Enthusiasts","Ex-Girlfriends",
...
var firstMax = firstArray.length -1;

var secondMax = secondArray.length -1;
...
var randomFirst = getRandomInt(0, firstMax);

var randomSecond = getRandomInt(0, secondMax);

console.log (firstArray[randomFirst] + ' ' + secondArray[randomSecond]);
